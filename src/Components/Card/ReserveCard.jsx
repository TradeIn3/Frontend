    ...
    return (
      ...
      <div className="card">
       ...
       <div className="card__btm">
         ...
         <p style={{fontSize:"1rem",paddingTop:"0.4rem",marginBottom:"2px"}} className="card__ttl">Expired on {item.expire_date}</p>
           <div className="card__btm__lft__price">{item.title}</div>
           <div style={{backgroundColor:"white",padding:0}}className="card__btm__lft__ship"><a style={{fontSize:"0.85rem"}} >View Reserve Details</a></div>
         </div>
