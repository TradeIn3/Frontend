        ...
        <Dialog
          ...
          >
            <DialogTitle className="ordertitle">
              <IconButton onClick={() => this.props.history.push(`/account/${this.props.match.params.id}/orders/`)}>
                <ArrowBackIcon />
              </IconButton>
              Order Summary
            </DialogTitle>
            ...
            <div className="ordersum__card">
              ...
              <div className="card__btm">
                <div className="card__btm__lft">
                  <p
                    style={{ fontSize: "1rem", paddingTop: "0.4rem",marginBottom:"2px" }}
                    className="card__ttl"
                  >
                  ...
                  >
                    <Link style={{ fontSize: "0.85rem" }} to={`/buy/${this.props.match.params.orderid}`}>
